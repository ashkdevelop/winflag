...
const DEFAULT_FAQS: FaqType[] = [
  { id: 'f1', question: 'What is the minimum order quantity (MOQ)?', answer: 'Our standard MOQ is 50 units for most flag types. For small table flags we can sometimes accommodate smaller quantities — contact us to discuss your specific needs.', category: 'Ordering', displayOrder: 1, isActive: true },
  ...
  { id: 'f4', question: 'How long does production take?', answer: 'Standard production is 3–7 business days after design approval and payment confirmation. We offer a 48-hour Express production option for urgent orders at an additional charge.', category: 'Delivery', displayOrder: 4, isActive: true },
  ...
  { id: 'f6', question: 'Do you provide GST invoices?', answer: 'Yes, we provide GST-compliant tax invoices for all orders. Our GST number is 29AABFW1234A1Z5. This is especially important for corporate and government clients who need to claim input tax credit.', category: 'Billing', displayOrder: 6, isActive: true },
  { id: 'f7', question: 'What sizes are available for country and advertising flags?', answer: 'Country Flags: 2ft×3ft, 3ft×4.5ft, 4ft×6ft. Advertising Flags: 2ft×6ft, 3ft×7ft, 4ft×8ft and custom sizes. Table Flags: 6×4 inches and 9×6 inches (standard). All sizes can be customised on request.', category: 'Products', displayOrder: 7, isActive: true },
  { id: 'f8', question: 'Can I get a custom design for my flag?', answer: 'Absolutely. Simply share your artwork (AI, EPS, PDF, or high-resolution PNG/JPG) when placing the order. Our design team can also create custom artwork at no extra charge for orders of 500+ units.', category: 'Ordering', displayOrder: 8, isActive: true },
  { id: 'f9', question: 'Do you deliver across India?', answer: 'Yes. We ship to all states and union territories across India via trusted courier partners. Delivery charge depends on your location and is shown during checkout. Express delivery is available to major cities.', category: 'Delivery', displayOrder: 9, isActive: true },
  { id: 'f10', question: 'How do I track my order?', answer: 'Once your order is dispatched, you will receive a tracking number via SMS and email. You can also use the Track Order page on our website to check your shipment status at any time.', category: 'Delivery', displayOrder: 10, isActive: true },
  { id: 'f11', question: 'What payment methods do you accept?', answer: 'We accept UPI (GPay, PhonePe, Paytm), NEFT/RTGS bank transfer, cheques, and cash payments at our office. For large B2B orders, payment-on-delivery is available subject to prior approval.', category: 'Billing', displayOrder: 11, isActive: true },
  { id: 'f12', question: 'What is your return and cancellation policy?', answer: 'Since flags are custom-printed, we do not accept returns for change-of-mind. If there is a manufacturing defect or wrong delivery, we will reprint or refund at no cost. Cancellations can be made before design approval without charge.', category: 'Ordering', displayOrder: 12, isActive: true },
];
